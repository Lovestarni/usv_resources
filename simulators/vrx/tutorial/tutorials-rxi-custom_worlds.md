...
* [Adding Course Elements](https://github.com/osrf/vrx/wiki/tutorials-Adding%20course%20elements)
* [Randomized Obstacle Course](https://osrf-migration.github.io/vrx-gh-pages/#!/osrf/vrx/pull-requests/54/page/1)
* [Create Custom Docks](https://github.com/osrf/vrx/wiki/tutorials-CreateDocks)
...
The `vrx_gazebo` package includes a number of RobotX specific models (see [vrx_gazebo/models](https://github.com/osrf/vrx/blob/master/vrx_gazebo/models/)).  These models are accessible through the Gazebo client GUI, but we will add them to the World file in order to create reusable worlds for development and practice.
...
We may also want a way to quickly generate randomized worlds so that we can practice with lots of different scenarios for a particular task.  For RobotX 2018 the UF team created a Python program to generate a randomized obstacle field model.  Notes on this contribution to VRX are in [PR#54](https://osrf-migration.github.io/vrx-gh-pages/#!/osrf/vrx/pull-requests/54/page/1).
