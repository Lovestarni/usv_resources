...
* Fixed stern thrusters and a single lateral thuster - the ['T' propulsion configuration](https://github.com/osrf/vrx/wiki/tutorials-PropulsionConfiguration)
...
```
![vrx.jpg](images/3012785430-vrx.jpg)
...
![rviz_vrx.png](images/1103626992-rviz_vrx.png)