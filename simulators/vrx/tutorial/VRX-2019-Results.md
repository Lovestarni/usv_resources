...
The following table includes the rank score for each of the six VRX tasks.  The rank score is for each task is derived from the task score as described in the [VRX Competition and Task Descriptions document](https://github.com/osrf/vrx/wiki/documentation).
...
All logs are available. See [this tutorial](https://github.com/osrf/vrx/wiki/download_logs) for instructions.
...
For [Phase 1 of the VRX challenge](https://github.com/osrf/vrx/wiki/events-19-phase1_helloworld) teams were tasked with creating a video to demonstrate their ability to setup, provision and run the VRX virtual environment.  This first step, "Hello World", showed that teams are well on their way to being able to submit full solutions for the next step, [Phase 2: Dress Rehearsal](https://github.com/osrf/vrx/wiki/events-19-dress_rehearsal).
